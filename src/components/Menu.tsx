      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 stagger-children">
          {meatKeys.map((key) => (
            <div
              key={key}
              className="reveal group relative overflow-hidden rounded-2xl bg-teal/10 border border-teal/20 hover:border-terracotta/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-terracotta/10"
            >
              {/* Image */}
