      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-gradient-to-r from-amber/10 to-terracotta/10 border border-amber/20 text-cream placeholder:text-cream/20 focus:border-amber/40 focus:outline-none focus:ring-1 focus:ring-amber/20 transition-all text-sm"
          />
        </div>
