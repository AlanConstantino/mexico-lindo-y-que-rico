...
export const emailTranslations = {
  ...
  en: {
    ...
    cashPending: {
      ...
      nonRefundable: (days: number) => `⚠️ This deposit is non-refundable if cancelled less than ${days} days before the event.`,
  ...
  es: {
    ...
    cashPending: {
      ...
      nonRefundable: (days: number) => `⚠️ Este depósito no es reembolsable si se cancela con menos de ${days} días de anticipación.`,
