...
export const emailTranslations = {
  ...
  en: {
    confirmation: {
      ...
      cancellationDepositNonRefundable: "Cash deposits are non-refundable if cancelled within the above window.",
    },
    cashPending: {
  ...
  es: {
    confirmation: {
      ...
      cancellationDepositNonRefundable: "Los depósitos en efectivo no son reembolsables si se cancela dentro del plazo mencionado.",
    },
    cashPending: {
