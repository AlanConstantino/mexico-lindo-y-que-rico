...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const cancellationFields = {
      ...
      ...(zelle_enabled !== undefined && { zelle_enabled }),
      ...(venmo_handle !== undefined && { venmo_handle }),
      ...(venmo_enabled !== undefined && { venmo_enabled }),
      ...(cashapp_handle !== undefined && { cashapp_handle }),
      ...(cashapp_enabled !== undefined && { cashapp_enabled }),
      ...(paypal_email !== undefined && { paypal_email }),
      ...(paypal_enabled !== undefined && { paypal_enabled }),
